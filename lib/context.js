 ...
 *
 * @param {String} name
 * @return {Array} [属性, 值, 是否为普通可缓存变量]，找不到返回null
 */
...
Context.prototype.throwTimeoutError = function () {
  throw new Error('Timeout ' + this.getCurrentPosition(true));
};
...
Context.prototype.throwLocalsUndefinedError = function (name) {
  this.debug('Locals ' + name + ' is undefined ' + this.getCurrentPosition(true));
};
...
Context.prototype.throwLoopItemUndefinedError = function (name) {
  this.debug('Loop item ' + name + ' is undefined ' + this.getCurrentPosition(true));
};
...
Context.prototype.throwLoopLocalsUndefinedError = function (name) {
  this.debug('Loop locals ' + name + ' is undefined ' + this.getCurrentPosition(true));
};
...
Context.prototype.throwFilterUndefinedError = function (name) {
  this.debug('Filter ' + name + ' is undefined ' + this.getCurrentPosition(true));
}
...
Context.prototype.throwUnknownOpcodeError = function (code) {
  this.debug('Unknown opcode ' + code + ' ' + this.getCurrentPosition(true));
};
