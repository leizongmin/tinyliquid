 ...
 * @param {object} models     获取数据的函数 {'name': function (callback) {}}
 * @param {object} options    选项： parallel: true 并行方式获取，默认为false    filters: 筛选器
...
exports.advRender = function (render, models, options, callback) {
  ...
  var dataList = AsyncDataList(models, names);
