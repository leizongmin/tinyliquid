...
execOpcode[OPCODE.LOCALS] = function (ast, context, callback) {
  ...
  if (info === null) {
    ...
    getLocalsCase[info[0]](info, ast, context, callback);
  }
};

var getLocalsCase = [];
// 静态变量
getLocalsCase[Context.prototype.STATIC_LOCALS] = function (info, ast, context, callback) {
...
// 通过函数获取的变量
getLocalsCase[Context.prototype.SYNC_LOCALS] = function (info, ast, context, callback) {
...
// 异步获取变量
getLocalsCase[Context.prototype.ASYNC_LOCALS] = function (info, ast, context, callback) {
